...
class MyApp extends StatelessWidget {
  List<String> tags = ['Python','JavaScrip','php','Website','Vbnet','AI','Maching Lerening',];
              ...
              child: Card(
                child: Container(
                  ...
                  child: Text ('Biodata Mahasiswa', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24,color: Colors.black)),
                    ...
                    Text( 'Nama       : Ahmad Santoso', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)
                        )
                      ]
                    ),
                      ),
                    ...
                    children: <Widget>[
                      Icon(Icons.dialpad),
                   Text('NIM          : 311710427', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)
                          )
                        ]
                        ),
                      ),
                   ...
                   Text('TTL          : MUBA 17-10-1997', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)
                          )
                        ]
                      ),
                    ),
                    ...
                    Text('E-mail      : ahmad270@gmail.com', style: TextStyle(fontWeight: FontWeight.bold, fontSize:18)
                         )
                       ]
                      ),
                    ),
